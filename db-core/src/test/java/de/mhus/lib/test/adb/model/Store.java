...
public class Store extends DbComfortableObject {
    ...
    @DbPersistent private java.sql.Date sqlDate;
    @DbPersistent private float floatValue;
    @DbPersistent private char charValue;
    @DbPersistent private double doubleValue;
    @DbPersistent private int intValue;
    @DbPersistent private short shortValue;
    @DbPersistent private byte byteValue;
    @DbPersistent private BigDecimal bigDecimalValue;
