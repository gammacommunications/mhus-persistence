...
/**
 * This define a prepared statement connected to a pool. The main differentz to DbStatement, it's
 * not connected to a DbConnection by creation time. But it will precompile the query string.
 *
 * @author mikehummel
 */
